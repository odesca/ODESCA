...
if(~partial)
    ...
    if( ~obj.checkParam() )
        error('ODESCA_Object:calculateNumericEquations:notAllParametersSet','The numeric equations can not be calculated because not all parameters have been set.');
    end
end
