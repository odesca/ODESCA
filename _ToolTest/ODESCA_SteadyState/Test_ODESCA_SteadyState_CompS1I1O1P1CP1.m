...
classdef Test_ODESCA_SteadyState_CompS1I1O1P1CP1 < ODESCA_Component
    %ODESCA_SteadyStateTest_Component2 Class for the test of ODESCA_System
    %
    % DESCRIPTION
    %   This class is used for the tests of the ODESCA_SteadyState class.
    %   It has the construction parameter c.
    %
    % PROPERTIES:
    %
    % CONSTRUCTOR:
    %   obj = ODESCA_SteadyStateTest_Component2()
    %
    % METHODS:
    %
    % LISTENERS:
    ...
    methods
        function obj = Test_ODESCA_SteadyState_CompS1I1O1P1CP1(name)
    ...
    methods(Access = protected)
        function calculateEquations(obj)
            ...
            obj.g(1) = (Input + Parameter)*(State^(obj.constructionParam.c));
