...
classdef Test_ODESCA_SteadyState_CompCommonWT < ODESCA_Component
    %Test_ODESCA_SteadyState_WT Example Component for the system tests
    %
    % DESCRIPTION
    ...
    methods
        function obj = Test_ODESCA_SteadyState_CompCommonWT(name)
            ...
            %   the calculation of the equations have to be spezified.
            %
            % NOTE
            %
            % SEE ALSO
