...
classdef Test_ODESCA_SteadyState_CompS1I1O1P1CP0 < ODESCA_Component
    %ODESCA_SteadyStateTest_Component Class for the test of ODESCA_System
    %
    % DESCRIPTION
    ...
    methods
        function obj = Test_ODESCA_SteadyState_CompS1I1O1P1CP0(name)
