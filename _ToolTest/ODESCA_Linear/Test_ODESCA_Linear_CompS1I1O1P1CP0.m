...
classdef Test_ODESCA_Linear_CompS1I1O1P1CP0 < ODESCA_Component
    %ODESCA_Linear_Component Class for the test of ODESCA_System
    %
    % DESCRIPTION
    %   This class is used for the tests of the ODESCA_Linear class.
    %
    % PROPERTIES:
    %
    % CONSTRUCTOR:
    %   obj = ODESCA_LinearTest_Component()
    %
    % METHODS:
    %
    % LISTENERS:
    ...
    methods
        function obj = Test_ODESCA_Linear_CompS1I1O1P1CP0(name)
