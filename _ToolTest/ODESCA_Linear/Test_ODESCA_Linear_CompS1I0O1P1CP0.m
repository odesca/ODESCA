...
classdef Test_ODESCA_Linear_CompS1I0O1P1CP0 < ODESCA_Component
    %ODESCA_LinearTest_Component Class for the test of ODESCA_System
    %
    % DESCRIPTION
    ...
    methods
        function obj = Test_ODESCA_Linear_CompS1I0O1P1CP0(name)
