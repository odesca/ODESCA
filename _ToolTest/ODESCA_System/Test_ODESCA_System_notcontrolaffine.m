...
classdef Test_ODESCA_System_notcontrolaffine < ODESCA_Component
    %Test_ODESCA_System_notcontrolaffine 
    %
    % DESCRIPTION
    ...
    %
    % CONSTRUCTOR:
    %   obj = Test_ODESCA_System_notcontrolaffine()
    %
    % METHODS:
    %
    % LISTENERS:
    ...
    methods
        function obj = Test_ODESCA_System_notcontrolaffine(name)
    ...
    methods(Access = protected)
        function calculateEquations(obj)
            ...
            obj.f(1) = -obj.x(1)+sin(obj.u(1))+obj.u(1)^2;
            obj.f(2) = obj.x(1) + sin(obj.x(2))+obj.u(2)*obj.x(2)^2;
