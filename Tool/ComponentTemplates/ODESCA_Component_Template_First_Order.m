...
classdef ODESCA_Component_Template_First_Order < ODESCA_Component
    %ODESCA_Component_Template_First_Order - Template for the creation of components
    %
    % DESCRIPTION
    ...
    methods
        function obj = ODESCA_Component_Template_First_Order(name)
